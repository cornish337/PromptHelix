...
class TestPromptArchitectAgent(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.architect_default = PromptArchitectAgent(knowledge_file_path=None)
    ...
    def test_agent_creation_and_default_config_loading(self):
        ...
        self.assertEqual(self.architect_default.llm_provider, DEFAULT_ARCHITECT_CONFIG["default_llm_provider"])
        self.assertEqual(self.architect_default.llm_model, DEFAULT_ARCHITECT_CONFIG["default_llm_model"])
        ...
        self.assertEqual(self.architect_default.knowledge_file_path, expected_kfp)
    ...
    def test_parse_requirements_llm_success(self, mock_call_llm_api):
        ...
        parsed = self.architect_default._parse_requirements("Original task", ["kw1"], {"max_len_orig": 150})
    ...
    def test_parse_requirements_llm_failure_falls_back(self, mock_call_llm_api):
        ...
        parsed = self.architect_default._parse_requirements("Task X", ["kwX"], {})
        mock_call_llm_api.assert_called_once()
    ...
    def test_select_template_llm_success(self, mock_call_llm_api):
        ...
        template_name = self.architect_default._select_template(parsed_reqs)
    ...
    def test_select_template_llm_invalid_response_falls_back(self, mock_call_llm_api):
        ...
        with patch.object(self.architect_default, '_fallback_select_template', return_value="generic_v1") as mock_fallback:
            template_name = self.architect_default._select_template(parsed_reqs)
    ...
    def test_select_template_llm_failure_falls_back(self, mock_call_llm_api):
        ...
        with patch.object(self.architect_default, '_fallback_select_template', return_value="summary_v1") as mock_fallback:
            template_name = self.architect_default._select_template(parsed_reqs)
    ...
    def test_populate_genes_llm_success(self, mock_call_llm_api):
        ...
        template = self.architect_default.templates["generic_v1"]
        parsed_reqs = {"task_description": "Do something.", "keywords": ["detail"]}
        
        genes = self.architect_default._populate_genes(template, parsed_reqs)
    ...
    def test_populate_genes_llm_malformed_response_falls_back(self, mock_call_llm_api):
        ...
        with patch.object(self.architect_default, '_fallback_populate_genes') as mock_fallback:
    ...
    def test_populate_genes_llm_failure_falls_back(self, mock_call_llm_api):
        ...
        with patch.object(self.architect_default, '_fallback_populate_genes', return_value=["Fallback gene"]) as mock_fallback:
            genes = self.architect_default._populate_genes(template, parsed_reqs)
    ...
    def test_process_request_missing_keywords_and_constraints(self, mock_call_llm_api):
        ...
        chromosome = self.architect_default.process_request(request_data)
    ...
    def test_process_request_full_fallback_due_to_llm_system_down(self, mock_call_llm_api_system_down):
        ...
        result_chromosome = self.architect_default.process_request(request_data)
