...
def main_ga_loop(return_best: bool = False):
    ...
    for i in range(num_generations):
        ...
        # Note: evolve_population internally increments generation_number AFTER processing
        ...
        if fittest_in_gen:
            ...
            # This might happen if population becomes empty, though current evolve_population tries to maintain size.
