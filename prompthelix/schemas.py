...
class UserFeedbackBase(BaseModel):
    ga_run_id: Optional[int] = None
    chromosome_id_str: Optional[str] = None
    prompt_content_snapshot: str = Field(..., min_length=1)
    user_id: Optional[int] = None # Can be derived from authenticated user or made optional for anonymous
